...
export default function Pricing() {
  ...
  const isPartner = api.stellarAccountRouter.isAllowedPartner.useQuery(
    {
      publicKey: publicKey!,
    },
    { enabled: !!publicKey },
  ...
  return (
    <div className="bg-background text-foreground">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <Card className="flex flex-col space-y-4 rounded-lg bg-card p-6">
              ...
              {!!isPartner.data ? (
                ...
                <Link href="/account?joinWaitlist=true" className="mt-4 pt-4">
                  <Button
                    variant="ghost"
                    className="group h-8 w-full border-[1px] border-black bg-black text-white hover:bg-white hover:text-black"
                  >
            ...
            <Card className="flex flex-col space-y-4 rounded-lg bg-card p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Only if auction is successful, we charge a publishing fee and a
                significant commission on each ticket sold, but don&apos;t
                worry, your earnings may be maximized by our auction-based
                reselling system.
              </p>
              <p className="text-sm text-muted-foreground">
                Buyers won&apos;t pay any service fee for auctioned tickets
              </p>
              <Link href="/how-to-resell" className="mt-4 pt-4">
                <Button
                  variant="ghost"
                  className="group h-8 w-full border-[1px] border-black bg-black text-white hover:bg-white hover:text-black"
                >
      ...
      <div className="mx-12 mb-10 flex rounded-md bg-muted p-4 text-center text-muted-foreground">
        <p>
