  ...
  return (
    <section className="flex w-full flex-col items-center justify-center bg-muted py-12 md:py-24">
      <div className="space-y-4 text-center">
        <h2 className="text-3xl font-bold text-foreground">No Events</h2>
        <p className="max-w-md text-muted-foreground">
          It looks like there are no upcoming events at the moment. Try
          searching for events to find something that interests you.
        </p>
        <Link
          href="/events"
